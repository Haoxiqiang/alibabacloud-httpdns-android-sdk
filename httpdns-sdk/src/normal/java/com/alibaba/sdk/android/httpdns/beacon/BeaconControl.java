...
public class BeaconControl {
    ...
    public static void initBeacon(Context context, final String accountId, final HttpDnsConfig httpDnsConfig) {
        ...
        Beacon beacon = new Beacon.Builder().defaultConfig().startPoll(false).extras(extras).build();
