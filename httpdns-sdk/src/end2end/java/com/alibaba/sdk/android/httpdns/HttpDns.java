...
public class HttpDns {
    ...
    private static HttpDnsInstanceHolder holder = new HttpDnsInstanceHolder(new InstanceCreator());
    ...
    public synchronized static HttpDnsService getService(final Context applicationContext) {
        return holder.get(applicationContext, CommonUtil.getAccountId(applicationContext), CommonUtil.getSecretKey(applicationContext));
    }
