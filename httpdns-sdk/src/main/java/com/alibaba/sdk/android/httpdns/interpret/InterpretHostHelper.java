...
public class InterpretHostHelper {
    ...
    public static HttpRequestConfig getConfig(HttpDnsConfig config, String host, RequestIpType type, Map<String, String> extras, String cacheKey, Map<String, String> globalParams) {
        ...
        return new HttpRequestConfig(config.getSchema(), config.getCurrentServer().getServerIp(), config.getCurrentServer().getPort(), path, config.getTimeout());
    }
    ...
    public static String getPath(HttpDnsConfig config, String host, RequestIpType type, Map<String, String> extras, HashMap<String, String> params) {
    ...
    private static String getExtra(Map<String, String> extras) throws UnsupportedEncodingException {
        ...
        if (extras != null) {
            Iterator<Map.Entry<String, String>> iterator = extras.entrySet().iterator();
    ...
    public static HttpRequestConfig getConfig(HttpDnsConfig config, ArrayList<String> hostList, RequestIpType type, SignService signService) {
        String query = getQuery(type);
        StringBuilder stringBuilder = new StringBuilder();
