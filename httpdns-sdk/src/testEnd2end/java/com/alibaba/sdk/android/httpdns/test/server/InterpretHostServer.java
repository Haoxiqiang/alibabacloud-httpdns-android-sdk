 ...
 * @date 2020/11/9
 */
public class InterpretHostServer extends BaseDataServer<InterpretHostServer.InterpretHostArg, InterpretHostResponse> {
    ...
    public static class InterpretHostArg {
        ...
        public static InterpretHostArg create(String host, RequestIpType type, HashMap<String, String> extras) {
            InterpretHostArg interpretHostArg = new InterpretHostArg();
            interpretHostArg.host = host;
            interpretHostArg.type = type;
        ...
        public static InterpretHostArg createFromInterpretHostRequest(RecordedRequest recordedRequest) {
        ...
        public boolean equals(Object o) {
            ...
            String str1 = formInterpretHostArg(((InterpretHostArg) o).host, ((InterpretHostArg) o).type, ((InterpretHostArg) o).extras);
         ...
         * @return
         */
        private static String formInterpretHostArg(String host, RequestIpType type, HashMap<String, String> extras) {
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append(host);
            switch (type) {
                case v6:
    ...
    public boolean hasRequestForArgWithParams(String host, List<String> params, int count, boolean removeRecord) {
        return hasRequestForArgWithParams(InterpretHostArg.create(host), params, count, removeRecord);
    }
    ...
    public boolean hasRequestForArgWithResult(String host, InterpretHostResponse data, int count, boolean removeRecord) {
        return hasRequestForArgWithResult(InterpretHostArg.create(host), data, count, removeRecord);
    }

    public boolean hasRequestForArgWithResult(String host, int httpCode, String body, int count, boolean removeRecord) {
        return hasRequestForArgWithResult(InterpretHostArg.create(host), httpCode, body, count, removeRecord);
    }
     ...
     * @return
     */
    public static InterpretHostResponse createResponse(String targetHost, String[] ips, String[] ipv6s, int ttl, String extra) {
